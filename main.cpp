...
const int wheel_ragne_min = 11;  //25;
const int wheel_range_max = 26; //145;
...
void loop()
{
  ...
  if (udp_setup == true)
  {
    ...
    if (packetSize)
    {
      ...
      byte wheel = udp.read();
      //client.write(1);
      byte remap_wheel = map(wheel, 60, 120, wheel_range_max, wheel_ragne_min);
